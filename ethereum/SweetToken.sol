...
contract SweetToken is Context, AccessControlEnumerable, ERC721Enumerable, 
        ERC721Burnable, ContextMixin, NativeMetaTransaction, Ownable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory name, string memory symbol, string memory baseTokenURI, uint32 maxTokenSupply, address _proxyRegistryAddress)
      ERC721(name, symbol) {
